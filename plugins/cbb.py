...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ OWNER: <a href='tg://user?id={OWNER_ID}'>K-Zen TV</a>\n○ MAIN DIRECTORY : <a href='https://t.me/K_ZenTv'>K_Zen TV</a>\n○ MOVIES CHANNEL : <a href='https://t.me/K_ZenMovies'>K-ZEN MOVIES</a>\n○ COMMUNITY : <a href='https://t.me/+npjbj_z59uYyZTM0'>K-Zen Chat</a>\n○ Movie Requests : <a href='https://t.me/+bc4ZizsFnoZjYzU0'>K-Zen Movies Chat</a></b>",
